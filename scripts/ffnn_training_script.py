...
if __name__ == '__main__':
    ...
    batch_size = 1000  # number of samples going through the model at each iteration during batch training
    ...
    for epoch in range(epochs):
        ...
        loss_test[epoch] = loss_function.forward(output, testY)
        acc_test[epoch] = np.mean(y_pred == testY)
