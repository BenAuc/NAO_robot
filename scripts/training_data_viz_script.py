...
dataset_filename = 'training_dataset_150_points_NAO_2022-06-25.npy'
dataset_filename = 'training_data_v3_06-06-2022.npy'
dataset_filename = 'training_data_v4_27-06-2022.npy'
dataset_filename = 'data_NAO.npy'
dataset_filename = 'training_data_today.npy'
dataset_filename = 'training_data_NAO_200_points_FINAL.npy'

path_to_dataset = '/home/bio/bioinspired_ws/src/tutorial_4/data/training_data_set/' + dataset_filename
#path_to_dataset = '/home/bio/bioinspired_ws/src/tutorial_4/data/' + dataset_filename
...
# us the following if you want to see just a few of all data points
...
plt.title("Training data distribution for " + str(x.shape[0]) + " points")
plt.show()
...
plt.title("Joint state distribution for " + str(training_dataset.shape[0]) + " points")
plt.show()
